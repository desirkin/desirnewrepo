...
// SOCIAL-1 closeout barrel — the implementation is split into ./social-settle/*.js.
// This module re-exports the exact same public surface; every importer is unchanged.
// social-settle stays the rumor-tier entry point that wires the discovery-catalog and
// admission-scope contracts (their event/validator surface is re-exported below).
const SOCIAL_SETTLE_WIRED_CONTRACTS = ['social-catalog.js', 'social-scope.js'];
void SOCIAL_SETTLE_WIRED_CONTRACTS;
export {
