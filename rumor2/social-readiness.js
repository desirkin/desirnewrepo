...
export function providerReadinessRow(providerId, { runtime = null, evaluation = null, knownAtTs = null } = {}) {
  ...
  const transportImplemented = p.transportImplemented === true || p.durable === true || runtime?.transportImplemented === true; // implementation is separate from access and durable retention
