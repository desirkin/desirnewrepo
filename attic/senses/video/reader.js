...
export function readVideoStatus(dataDir) { try { const f = videoStatusFile(dataDir); if (!existsSync(f)) return null; const s = readJsonBounded(f); return s && s.v === VIDEO_STATUS_VERSION && typeof s.state === 'string' ? s : null; } catch { return null; } }
