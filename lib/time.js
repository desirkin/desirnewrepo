...
// Cockpit display stamp in ET: "MM/DD HH:MM" (24h). Display only; never an input to a decision.
const ET_STAMP = new Intl.DateTimeFormat('en-US', { timeZone: 'America/New_York', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', hour12: false });
export function etStamp(at) {
  return ET_STAMP.format(at instanceof Date ? at : new Date(at)).replace(',', '');
}
