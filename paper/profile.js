...
export const SECRET_ENV_NAMES = Object.freeze(['SERPENT_CONTROL_PASSWORD', 'DATABASE_URL', 'X_BEARER_TOKEN', 'FRED_API_KEY', 'COINGECKO_DEMO_API_KEY', 'COINGLASS_API_KEY', 'CRYPTOQUANT_API_KEY', 'SANTIMENT_API_KEY', 'TOKENOMIST_API_KEY', 'ANTHROPIC_API_KEY', 'KRAKEN_L3_DATA_API_KEY', 'KRAKEN_L3_DATA_API_SECRET', 'JUDGE_OWNER_PASSWORD', 'CLOUDFLARE_API_TOKEN', 'YOUTUBE_API_KEY', 'NEYNAR_API_KEY', 'REDDIT_CLIENT_ID', 'REDDIT_CLIENT_SECRET', 'STOCKTWITS_STREAM_USER', 'STOCKTWITS_STREAM_PASS', 'META_APP_TOKEN']);
