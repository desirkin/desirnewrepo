...
export const KIND_SUBJECTS = deepFreeze({
  ...
  DERIVATIVE_TICK: ['DERIVATIVE'], LIQUIDATION: ['DERIVATIVE', 'ASSET'], ASSET_REFERENCE: ['ASSET', 'TOKEN'],
  UNLOCK_EVENT: ['ASSET', 'TOKEN'], DEX_POOL: ['POOL'], DEFI_METRIC: ['PROTOCOL', 'ASSET'], ONCHAIN_METRIC: ['ASSET', 'TOKEN'],
  STABLECOIN_METRIC: ['ASSET', 'TOKEN'], ETF_FLOW: ['ASSET'], ECONOMIC_EVENT: ['SERIES'],
  EVENT_REFERENCE: ['ASSET', 'PROVIDER'], PROVIDER_STATUS: ['PROVIDER'],
