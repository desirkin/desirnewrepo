...
const KIND_FAMILY = { TRADE: 'SPOT_FLOW', BOOK_SNAPSHOT: 'DISPLAYED_LIQUIDITY', BOOK_COVERAGE: 'DISPLAYED_LIQUIDITY', CANDLE: 'SPOT_PRICE_CHART', INSTRUMENT: 'DERIVATIVES_FUNDING_OI', DERIVATIVE_TICK: 'DERIVATIVES_FUNDING_OI', LIQUIDATION: 'LIQUIDATIONS', ASSET_REFERENCE: 'SUPPLY_UNLOCKS', UNLOCK_EVENT: 'SUPPLY_UNLOCKS', DEX_POOL: 'DEX_DEFI', DEFI_METRIC: 'DEX_DEFI', ONCHAIN_METRIC: 'ONCHAIN_ENTITY_FLOW', STABLECOIN_METRIC: 'STABLECOIN_LIQUIDITY', ETF_FLOW: 'ETF_FLOWS', ECONOMIC_EVENT: 'MACRO_RELEASES', DERIVATIVE_ANALYTIC_BUCKET: 'DERIVATIVES_PRESSURE', L3_BOOK_SNAPSHOT: 'L3_MICROSTRUCTURE', L3_ORDER_EVENT: 'L3_MICROSTRUCTURE', L3_BOOK_COVERAGE: 'L3_MICROSTRUCTURE', EVENT_REFERENCE: 'OFFICIAL_SOCIAL_EVENTS', PROVIDER_STATUS: 'INFRASTRUCTURE_STATUS' };
