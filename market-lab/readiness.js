...
export const CONTRACT_TEST_FILES = deepFreeze({ KRAKEN_SPOT: 'test/market-lab-providers.test.js', COINBASE_SPOT: 'test/market-lab-providers.test.js', KRAKEN_DERIVATIVES: 'test/market-lab-providers.test.js', COINGECKO: 'test/market-lab-providers.test.js', GECKOTERMINAL: 'test/market-lab-providers.test.js', DEFILLAMA: 'test/market-lab-providers.test.js', COINGLASS: 'test/market-lab-providers.test.js', CRYPTOQUANT: 'test/market-lab-providers.test.js', SETTLED_RECORDS: 'test/market-lab-providers.test.js', TOKENOMIST: 'test/market-lab-providers.test.js' });
