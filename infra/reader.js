...
export function readInfraStatus(dataDir) { try { const f = infraStatusFile(dataDir); if (!existsSync(f)) return null; const s = JSON.parse(readFileSync(f, 'utf8')); return s && s.v === INFRA_STATUS_VERSION && s.sources && typeof s.sources === 'object' ? s : null; } catch { return null; } }
