...
test('4E-2. static: the new modules import only inside rumor2 (shared contract, sealed time boundary, shared primitive, the Farcaster adapter), carry no capability marker, and no production module imports them', () => {
  ...
  assert.deepEqual(consumers.sort(), ['rumor2/providers/meta-graph-official.js', 'rumor2/providers/tiktok-research-official.js', 'rumor2/social-current-clients.js', 'rumor2/social-farcaster-runtime.js'], 'only owner-authorized sensor transports and evidence-only official boundary clients consume the pure access gates');
