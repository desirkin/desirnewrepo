...
// =========================================================================================
test('NO-ACT-TIME. the repair changes no capability: Farcaster still has no transport or collector path; key presence is configuration only; retention firewalls hold; the surviving adapter clock paths are wired to the boundary with no Date.parse left', () => {
