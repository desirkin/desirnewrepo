...
if (!TEST_URL) {
  ...
  const withDb = async (fn) => {
    ...
    try {
      ...
      assert.equal(m.schemaVersion, 9, 'old law 8, new law 9 (focused-completion experiment records, additive): writer-epoch schema landed (JUDGE execution schema 8 is additive; 1-7 untouched)');
